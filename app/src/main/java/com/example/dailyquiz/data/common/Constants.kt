package com.example.dailyquiz.data.common

object Constants {
    const val BASE_URL = "https://opentdb.com/"
    const val DEFAULT_QUESTION_AMOUNT = 10
    const val REVIEW_ARG_KEY = "sessionId"
    ...
    val difficulty = listOf("easy", "medium", "hard") // Обычно в API в lower case
    val type = listOf("multiple", "boolean") // Обычно в API это такие значения ("multiple" и "boolean")
}
